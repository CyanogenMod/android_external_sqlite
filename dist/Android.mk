...
LOCAL_SHARED_LIBRARIES := libsqlite libncurses
LOCAL_STATIC_LIBRARIES := libreadline

LOCAL_C_INCLUDES := $(LOCAL_PATH)/../android $(LOCAL_PATH)/../../bash/lib
...
LOCAL_CFLAGS += -DHAVE_USLEEP=1 -DTHREADSAFE=1 -DNDEBUG=1 -DHAVE_READLINE=1
